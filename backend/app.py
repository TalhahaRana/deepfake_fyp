...
# model = tf.keras.models.load_model('D:/fpy/the_model.keras')  # Adjust the model path as needed
...
# # Function to crop center square
...
#     result = 'The video is FAKE' if prediction >= 0.5 else 'The video is REAL'
#     return result
...
# model = tf.keras.models.load_model('D:/fyp/fypC/models/the_model.keras')
